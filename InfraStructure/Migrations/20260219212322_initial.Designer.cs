...
namespace InfraStructure.Migrations
{
    ...
    [Migration("20260219212322_initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Hassann_Khala.Domain.ProductStock", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Hassann_Khala.Domain.Section", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Hassann_Khala.Domain.SectionStock", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Hassann_Khala.Domain.Stock", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Hassann_Khala.Domain.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2026, 2, 19, 21, 23, 10, 735, DateTimeKind.Utc).AddTicks(9175),
                            Password = "123456",
                            Role = "Admin",
                            Username = "admin"
                        },
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2026, 2, 19, 21, 23, 10, 735, DateTimeKind.Utc).AddTicks(9935),
                            Password = "123456",
                            Role = "StoreKeeper",
            ...
            modelBuilder.Entity("Hassann_Khala.Domain.InboundDetail", b =>
                {
                    b.HasOne("Hassann_Khala.Domain.Inbound", "Inbound")
                        .WithMany("Details")
                        .HasForeignKey("InboundId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Hassann_Khala.Domain.Product", "Product")
                        .WithMany()
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Hassann_Khala.Domain.Section", "Section")
                        .WithMany()
            ...
            modelBuilder.Entity("Hassann_Khala.Domain.OutboundDetail", b =>
                {
                    b.HasOne("Hassann_Khala.Domain.Outbound", "Outbound")
                        .WithMany("Details")
