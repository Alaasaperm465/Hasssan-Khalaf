...
{
    /// <inheritdoc />
    public partial class AdditionalEntry : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SerialContruct = table.Column<int>(type: "int", nullable: false),
                    AllowedProductTypes = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AdditionalEntry = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Inbounds_Delegate_DelegateId",
                        column: x => x.DelegateId,
                        principalTable: "Delegate",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Inbounds_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Outbounds_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 3, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "S3", null },
                    { 4, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "S4", null },
                    { 5, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "S5", null },
                    { 6, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "S6", null },
                    { 7, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "S7", null },
                    { 8, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "S8", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2026, 2, 19, 0, 0, 0, 0, DateTimeKind.Unspecified), "123456", "Admin", null, "admin" },
                    { 2, new DateTime(2026, 2, 19, 0, 0, 0, 0, DateTimeKind.Unspecified), "123456", "StoreKeeper", null, "storekeeper" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Inbounds_DelegateId",
                table: "Inbounds",
                column: "DelegateId");

            migrationBuilder.CreateIndex(
                name: "IX_Inbounds_UserId",
                table: "Inbounds",
                column: "UserId");
