...
builder.Services.AddScoped<Hassann_Khala.Application.Interfaces.IRepositories.IProductRepository, ProductRepository>();
// register domain product repository (some services depend on the domain interface)
builder.Services.AddScoped<Hassann_Khala.Domain.Interfaces.IProductRepository, ProductRepository>();
